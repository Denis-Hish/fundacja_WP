function ssc_init() {
   if (document.body) {
      ...
      ssc_fixedback || ((e.style.backgroundAttachment = 'scroll'), (s.style.backgroundAttachment = 'scroll')),
...
function ssc_scrollArray(e, s, c, t) {
   if (
      ...
      ssc_que.push({ x: s, y: c, lastX: 0 > s ? 0.99 : -0.99, lastY: 0 > c ? 0.99 : -0.99, start: +new Date() }),
      !ssc_pending)
   ) {
      var o = function () {
...
function ssc_pulse_(e) {
   ...
   return (
      ...
      1 > e
         ? (s = e - (1 - Math.exp(-e)))
         : ((c = Math.exp(-1)), (e -= 1), (t = 1 - Math.exp(-e)), (s = c + t * (1 - c))),
